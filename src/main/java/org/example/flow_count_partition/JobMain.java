...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        // 创建一个job任务对象
        Job job = Job.getInstance(super.getConf(), "flow_count_partition");
        // 如果打包运行出错，则需要加该配置
...
//        TextInputFormat.addInputPath(job, new Path("hdfs://10.211.55.10:8020/input/flowcount"));
        TextInputFormat.addInputPath(job, new Path("file:///Users/sunjiabin/IdeaProjects/mapreduce/input/flowcount_partition"));
...
//        TextOutputFormat.setOutputPath(job, path);
        TextOutputFormat.setOutputPath(job, new Path("file:///Users/sunjiabin/IdeaProjects/mapreduce/output/flowcount_partition"));
